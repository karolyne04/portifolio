...
export default function Card({ imageUrl, name, link, className }: CardProps) {
  return (
    <Link href={link || "#"} passHref>
      <div className="w-full h-full max-w-lg bg-white rounded-lg shadow-lg overflow-hidden transition-transform transform hover:scale-105">
        ...
        <div className="px-6 py-4 bg-gray-100 h-32">
